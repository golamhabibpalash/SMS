...
{
    public partial class sp_get_attendance_by_date___Modified : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
			...
			//        Class_Designation = table.Column<string>(type: "nvarchar(max)", nullable: true),
			//        Phone = table.Column<string>(type: "nvarchar(max)", nullable: true),
			//        PunchTime = table.Column<string>(type: "nvarchar(max)", nullable: true)
			//    },
			//    constraints: table =>
			//    {
			//    });

			string modifiedSP = @"USE [SMSDB]
								GO
								/****** Object:  StoredProcedure [dbo].[sp_get_attendance_by_date]    Script Date: 8/19/2022 8:00:11 PM ******/
								SET ANSI_NULLS ON
								GO
								...
								-- =============================================
																	...
																	BEGIN
																		...
																		ELSE
																			BEGIN
																				...
																				WHERE FORMAT(t.PunchDatetime, 'yyyy-MM-dd') = @date and
																				LEN(CONVERT(int,t.CardNo))=9)
																				) emp ORDER BY emp.[PunchTime],emp.JoiningDate	
																			END
																	END
																ELSE
																	BEGIN
															...
															END
								";
			migrationBuilder.Sql(modifiedSP);
        }
