...
builder.Services.AddScoped<IClaimStoreManager, ClaimStoreManager>();
builder.Services.AddScoped<IClaimStoreRepository, ClaimStoreRepository>();

builder.Services.AddScoped<IProjectModuleManager, ProjectModuleManager>();
builder.Services.AddScoped<IProjectModuleRepository, ProjectModuleRepository>();

builder.Services.AddScoped<IProjectSubModuleManager, ProjectSubModuleManager>();
builder.Services.AddScoped<IProjectSubModuleRepository, ProjectSubModuleRepository>();
