...
namespace SMS.App.Controllers
{
    ...
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(IWebHostEnvironment host,  IEmployeeManager employeeManager, IGenderManager genderManager, IReligionManager religionManager, IMapper mapper, INationalityManager nationalityManager, IEmpTypeManager empTypeManager, IDesignationManager designationManager, IDivisionManager divisionManager, IDistrictManager districtManager, IUpazilaManager upazilaManager, IBloodGroupManager bloodGroupManager, UserManager<ApplicationUser> userManager, IPhoneSMSManager phoneSMSManager) 
        {
            _host = host;
                ...
                if (isSaved)
                {
                    ...
                    if (user==null)
                    {
                        ...
                        if (result.Succeeded)
                        {
                            ...
                            {
                                string text = "A user is created as a Teacher.\nUserName : " + employee.Email + "\nPassword: " + autoGeneratedPassword + "\n-NRS";
