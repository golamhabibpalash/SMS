...
namespace SMS.DB.Migrations
{
    ...
    [Migration("20260821192919_AddAttendanceMachineAndFingerprintFields")]
    partial class AddAttendanceMachineAndFingerprintFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SMS.Entities.AdditionalModels.Finance.PreviouisPaymentDetailsDto", b =>
                {
                    ...
                    b.ToView("PreviousPaymentsSummery", (string)null);
                });

            modelBuilder.Entity("SMS.Entities.AdditionalModels.PaidAmountResult", b =>
                {
                    ...
                    b.ToView("PaidAmountResults", (string)null);
                });

            modelBuilder.Entity("SMS.Entities.AdditionalModels.StudentListVM", b =>
                {
                    b.Property<int>("AcademicSessionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SMS.Entities.AdditionalModels.StudentPaymentSchedulePaidVM", b =>
                {
                    b.Property<int>("FeeHeadSL")
                        .HasColumnType("int");
                    ...
                    b.ToView("StudentPaymentSchedulePaidVMs", (string)null);
                });

            modelBuilder.Entity("SMS.Entities.AdditionalModels.StudentPaymentScheduleVM", b =>
                {
                    ...
                    b.ToView("StudentPaymentScheduleVMs", (string)null);
                });

            modelBuilder.Entity("SMS.Entities.AdditionalModels.StudentPaymentSummerySMS_VM", b =>
                {
                    b.Property<decimal>("NonResidentialPayment")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("ResidentialPayment")
                        .HasColumnType("decimal(18,2)");

                    b.ToTable("studentPaymentSummerySMS_VMs");
                });
            ...
            modelBuilder.Entity("SMS.Entities.AppliedStudent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AimInLife")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AppliedStudentStatus")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("FatherMonthlyIncome")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("InterestedAppliedClassId")
                        .HasColumnType("int");

                    b.Property<string>("MACAddress")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MotherMonthlyIncome")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("PreviousSchoolClassId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SMS.Entities.AttachDoc", b =>
                {
                    ...
                    b.Property<int>("AttachDocTypeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SMS.Entities.AttachDocType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SMS.Entities.AttendanceMachine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SMS.Entities.ClassPeriods", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SMS.Entities.ClassRoutine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SMS.Entities.Days", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SMS.Entities.ExamResult", b =>
                {
                    ...
                    b.Property<double>("TotalObtainMarks")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("SMS.Entities.GradingTable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SMS.Entities.Log", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SMS.Entities.NotificationEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SMS.Entities.RptModels.AttendanceVM.RptDailyAttendaceVM", b =>
                {
                    ...
                    b.ToView("RptDailyAttendaceVMs", (string)null);
                });

            modelBuilder.Entity("SMS.Entities.RptModels.Results.StudentWiseMarkSheetVM", b =>
                {
                    b.Property<int>("AcademicClassId")
                        .HasColumnType("int");
                    ...
                    b.ToView("StudentWiseMarkSheetVMs", (string)null);
                });

            modelBuilder.Entity("SMS.Entities.RptModels.Results.SubjectWiseMarkSheetVM", b =>
                {
                    b.Property<int>("AcademicExamId")
                        .HasColumnType("int");
                    ...
                    b.ToView("SubjectWiseMarkSheetVMs", (string)null);
                });
            ...
            modelBuilder.Entity("SMS.Entities.RptModels.RptAdmitCardVM", b =>
                {
                    ...
                    b.ToView("RptAdmitCardVMs", (string)null);
                });
            ...
            modelBuilder.Entity("SMS.Entities.RptModels.StudentPayment.RptPaymentReceiptVM", b =>
                {
                    b.Property<int>("ClassRoll")
                        .HasColumnType("int");
                    ...
                    b.ToView("RptPaymentReceiptVMs", (string)null);
                });
            ...
            modelBuilder.Entity("SMS.Entities.RptModels.StudentPayment.RptStudentsPaymentVM", b =>
                {
                    ...
                    b.ToView("RptStudentsPaymetnsVMs", (string)null);
                });
            ...
            modelBuilder.Entity("SMS.Entities.RptModels.rptStudentPaymentsVM", b =>
                {
                    ...
                    b.ToView("RptStudentPaymetnsVMs", (string)null);
                });
            ...
            modelBuilder.Entity("SMS.Entities.SetupMobileSMS", b =>
                {
                    ...
                    b.Property<bool>("AbsentNotificationEmployee")
                        .HasColumnType("bit");

                    b.Property<bool>("AbsentNotificationStudent")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("DailyCollectionSMSService")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("SMS.Entities.StudentFeeAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("FeeAllocationApplication")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("ClassFeeListId");

                    b.HasIndex("StudentFeeHeadId");

                    b.HasIndex("StudentId");

                    b.ToTable("StudentFeeAllocations");
                });
            ...
            modelBuilder.Entity("SMS.Entities.SubjectEnrollmentDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SubjectEnrollmentId");

                    b.ToTable("SubjectEnrollmentDetails");
                });

            modelBuilder.Entity("SMS.Entities.TeacherSubjectMap", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SMS.Entities.Tran_MachineRawPunch", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Tran_MachineRawPunchId"));
            ...
            modelBuilder.Entity("SMS.Entities.AttachDoc", b =>
                {
                    b.HasOne("SMS.Entities.AttachDocType", "AttachDocType")
                        .WithMany()
                        .HasForeignKey("AttachDocTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SMS.Entities.ClassRoutine", b =>
                {
                    ...
                    b.HasOne("SMS.Entities.ClassPeriods", "ClassPeriods")
                        .WithMany()
                        .HasForeignKey("ClassPeriodsId");
                    ...
                    b.HasOne("SMS.Entities.Days", "Days")
                        .WithMany()
            ...
            modelBuilder.Entity("SMS.Entities.Notification", b =>
                {
                    b.HasOne("SMS.Entities.NotificationEvent", "NotificationEvent")
                        .WithMany()
            ...
            modelBuilder.Entity("SMS.Entities.StudentFeeAllocation", b =>
                {
                    b.HasOne("SMS.Entities.ClassFeeList", "ClassFeeList")
                        .WithMany()
                        .HasForeignKey("ClassFeeListId");
            ...
            modelBuilder.Entity("SMS.Entities.SubjectEnrollmentDetail", b =>
                {
                    ...
                    b.HasOne("SMS.Entities.SubjectEnrollment", "SubjectEnrollment")
                        .WithMany("EnrolledSubjects")
                        .HasForeignKey("SubjectEnrollmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("SubjectEnrollment");
                });

            modelBuilder.Entity("SMS.Entities.TeacherSubjectMap", b =>
                {
                    b.HasOne("SMS.Entities.AcademicClassSubject", "ClassSubjects")
                        .WithMany()
